...
function HeroBanner() {
  return (
    <>
      <div className="px-4 md:px-[30px] 2xl:px-0 2xl:container 2xl:mx-auto">
        <div
          className="relative min-h-[765px] w-full flex flex-col justify-between p-4 md:p-8 text-white rounded-[22px]"
        >
